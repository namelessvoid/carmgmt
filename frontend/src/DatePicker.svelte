...
<input name="date" type="date" value={getDateString(value)} on:change={(e) => setDate(e.target.value)} />
<input name="time" type="time" value={getTimeString(value)} on:change={(e) => setTime(e.target.value)} />